...
# --------------------------
#DB_CONN_STRING = os.getenv('DB_CONN_STRING', 'prod-database-instance.cwtacmhn98xs.us-east-1.rds.amazonaws.com:5432/proddatabase')
ENDPOINT="prod-database-instance.cwtacmhn98xs.us-east-1.rds.amazonaws.com"
PORT="5432"
USER="julie"
REGION="us-east-1"
DBNAME="proddatabase"
PASSWORD="holyghost123"
